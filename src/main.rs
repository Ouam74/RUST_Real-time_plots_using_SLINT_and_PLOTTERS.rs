...
use slint::{RgbaColor, Color, SharedPixelBuffer, Brush, SharedString};
...
fn render_plot(newserie: Vec<(f64, f64)>) -> slint::Image {
    let mut pixel_buffer = slint::SharedPixelBuffer::new(800, 480);
